...
- `enrollment-node-tests`: rerun `node --test scripts/chrome-devtools-startup.test.mjs scripts/enrollment-download-artifacts.test.mjs tools/m2-enrollment/tests/*.test.mjs`.
